...
const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    title: 'العزيزية',
    category: 'settlements',
    categoryLabel: 'الهجر والبلدات',
    description: 'إحدى الديار المدرجة في سجل مواطن قبيلة السياحين.',
    story: 'تُعرض العزيزية هنا ضمن قائمة الديار، مع المحافظة على الاسم كما هو في سجل الموقع.'
  },
  {
    id: 6,
    title: 'الهمجة',
    ...
    categoryLabel: 'الهجر والبلدات',
    description: 'إحدى الديار المدرجة في سجل مواطن قبيلة السياحين.',
    story: 'تُعرض الهمجة هنا ضمن قائمة الديار، مع المحافظة على الاسم كما هو في سجل الموقع.'
  },
  {
    id: 7,
    title: 'الهواوية',
    ...
    categoryLabel: 'الهجر والبلدات',
    description: 'إحدى الديار المدرجة في سجل مواطن قبيلة السياحين.',
    story: 'تُعرض الهواوية هنا ضمن قائمة الديار، مع المحافظة على الاسم كما هو في سجل الموقع.'
  },
  {
    id: 4,
