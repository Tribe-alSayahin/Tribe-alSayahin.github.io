...
const FEATURES = [
  ...
  },
  {
    icon: Settings,
    title: 'إدارة المحتوى',
    description: 'لوحة تحكم مخصصة للمشرفين لإضافة المحتوى وحذفه ومراجعته.',
  },
];
        ...
        <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex-1">
            ...
            <p className="font-sans text-sm text-sand-dim leading-loose max-w-[480px]">
              بوابة المشرفين لإدارة المحتوى المنشور على الموقع من أخبار ومناسبات. يتطلب الدخول بريداً
              إلكترونياً وكلمة مرور.
            </p>
          </div>
