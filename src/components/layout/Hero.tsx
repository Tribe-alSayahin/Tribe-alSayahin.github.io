...
export function Hero({ scrollToSection }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <h1 className="sr-only">قبيلة السياحين (السيحاني) — الموقع الرسمي — إرث تالد وديار أصيلة</h1>
      <p className="sr-only">الموقع الرسمي لقبيلة السياحين (السيحاني) — توثيق النسب والديار والشعر والأرشيف الاستشراقي والأخبار والمناسبات</p>
