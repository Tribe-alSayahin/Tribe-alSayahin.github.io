export const baajStory = [
  ...
  'ولما وصل أطراف ديارهم، أخذ يرقب الحلال من بعيد مترصّدًا الفرصة المناسبة للغزو. ثم تهيأت له الفرصة عند أحد الذود، فأغار عليه وصاحبه نائم. وكان في الذود ناقتان مجاهيم مضيّرتان على البو.',
