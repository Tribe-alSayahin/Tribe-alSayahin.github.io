...
export function ThanksLetterGenerator() {
  ...
  const handlePrint = () => {
    const html = buildLetterHtml({ hijriDate, gregorianDate, openingLine, closingLine, signatureName });
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-brass/20 bg-ink-2/60 p-6">
        ...
        <p className="text-sm text-sand-dim">
          أُنشئ تلقائياً من قائمة الداعمين المعتمدة — قم بتخصيص النص ثم اطبعه أو احفظه PDF.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-brass/15 bg-brass/5 p-4 text-sm text-sand-dim font-sans">
        ...
        الخطاب مرتبط تلقائياً بقائمة الداعمين في لوحة الداعمين ويحتوي حالياً على{' '}
